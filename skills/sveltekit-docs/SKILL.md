---
name: sveltekit-docs
description: Search SvelteKit official documentation. Use when answering questions about SvelteKit routing, load functions, form actions, adapters, hooks, deployment, SSR, SSG, SPA mode, or project structure. Triggers on "SvelteKit", "sveltekit docs", "+page", "+layout", "+server", "load function", "form actions", "adapter", "hooks", "sveltekit routing".
allowed-tools: Read, Grep, Glob
---

# Skill: sveltekit-docs

**On load:** Read `../../.claude-plugin/plugin.json` from this skill's base directory. Display `sveltekit-docs v{version}` before proceeding.
...
```
${CLAUDE_SKILL_DIR}/../../refs/sveltekit-docs/
```
