---
description: "Use when checking accessibility, screen reader compatibility, or WCAG compliance."
---
...
Dispatch Agent:
  ...
  prompt: |
    ...
    4. Read: ${CLAUDE_PLUGIN_ROOT}/skills/a11y-audit/references/a11y-checklist.md
...
Dispatch Agent:
  ...
  prompt: |
    1. Run: ${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/browser.sh ensure
    2. Run: ${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/cdp-browser.js dom
