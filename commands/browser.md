---
description: "Use when interacting with a browser during Svelte or web development."
---
...
All scripts live at `${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/`. Run them with Bash.
...
Dispatch Agent:
  ...
  prompt: |
    1. Run: ${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/browser.sh ensure
    2. Run: ${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/cdp-browser.js dom [--selector "CSS_SELECTOR" if user specified an element]
...
Dispatch Agent:
  ...
  prompt: |
    1. Run: ${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/browser.sh ensure
    2. Run: ${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/cdp-browser.js accessibility
...
Dispatch Agent:
  ...
  prompt: |
    ...
    ${CLAUDE_PLUGIN_ROOT}/skills/browser/scripts/
